    ...
    <div className="max-w-7xl mx-auto px-5 py-12">
      ...
      <header className="mb-10">
        ...
        <p className="text-muted mt-3 max-w-3xl">
          {totalMocks} curated tests · built from a <b>906-question</b> bank covering GATE MN 2010–2025 · same difficulty mix as the real paper.
        </p>
